...
RSpec.configure do |config|
  ...
  config.before do
    stub_request(:get, "#{PipelineDealsApi.config[:pipelinedeals_api]}/" \
      "deals.json?api_key=#{PipelineDealsApi.credentials[:api_key]}")
      .to_return(
        status: 200,
        body: File.read('./spec/support/deals.json'),
        headers: {}
      )
